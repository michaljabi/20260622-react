...
export function Header({
  ...
  return (
    <header className="mx-auto max-w-6xl flex items-center p-3 md:p-6 border-slate-600 border-b">
      ...
      <div className="mr-3 flex bg-indigo-300 text-black p-1 px-2 rounded">
        {icon} { iconName ? PossibleIcons[iconName] : ''}
      </div>
      <span className="md:text-xl lg:text-2xl mr-6">
        {title}
